...
class Mais_foto_2_capture : AppCompatActivity() {
    var PularFoto: Button? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mais_foto_2_capture)
        ...
        PularFoto!!.setOnClickListener {
            val intent = Intent(this@Mais_foto_2_capture, Mais_Fotos_3::class.java)
