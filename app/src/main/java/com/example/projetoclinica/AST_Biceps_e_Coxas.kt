...
class AST_Biceps_e_Coxas: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ast_biceps_e_coxas)
        ...
        Continuar!!.setOnClickListener {
            val intent = Intent(this@AST_Biceps_e_Coxas, Adicionar_Medicoes::class.java)
            startActivity(intent)
            finish()
        }
        imageView = findViewById(R.id.imageView)
        imageView!!.setOnClickListener {
            val intent = Intent(this@AST_Biceps_e_Coxas, Biceps_e_Coxas::class.java)
            startActivity(intent)
            finish()
        }
    }
