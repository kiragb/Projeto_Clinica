...
class AST_Coxas_e_Abdomen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ast_coxas_e_abdomen)
        ...
        Continuar!!.setOnClickListener {
            val intent = Intent(this@AST_Coxas_e_Abdomen, Adicionar_Medicoes::class.java)
            startActivity(intent)
            finish()
        }
        imageView = findViewById(R.id.imageView)
        imageView!!.setOnClickListener {
            val intent = Intent(this@AST_Coxas_e_Abdomen, Coxas_e_Abdomen::class.java)
            startActivity(intent)
            finish()
        }
    }
