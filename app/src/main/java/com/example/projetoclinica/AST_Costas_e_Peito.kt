...
class AST_Costas_e_Peito : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ast_costas_e_peito)
        ...
        Continuar!!.setOnClickListener {
            val intent = Intent(this@AST_Costas_e_Peito, Adicionar_Medicoes::class.java)
            startActivity(intent)
            finish()
        }
        imageView = findViewById(R.id.imageView)
        imageView!!.setOnClickListener {
            val intent = Intent(this@AST_Costas_e_Peito, Costas_e_Peito::class.java)
            startActivity(intent)
            finish()
        }
    }
