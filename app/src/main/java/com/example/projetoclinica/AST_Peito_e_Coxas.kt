...
class AST_Peito_e_Coxas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ast_peito_e_coxas)
        ...
        Continuar!!.setOnClickListener {
            val intent = Intent(this@AST_Peito_e_Coxas, Adicionar_Medicoes::class.java)
            startActivity(intent)
            finish()
        }
        imageView = findViewById(R.id.imageView)
        imageView!!.setOnClickListener {
            val intent = Intent(this@AST_Peito_e_Coxas, Peito_e_Coxas::class.java)
            startActivity(intent)
            finish()
        }
    }
