...
class AST_Biceps_e_Costas: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ast_biceps_ecostas)
        ...
        Continuar!!.setOnClickListener {
            val intent = Intent(this@AST_Biceps_e_Costas, Adicionar_Medicoes::class.java)
            startActivity(intent)
            finish()
        }
        imageView = findViewById(R.id.imageView)
        imageView!!.setOnClickListener {
            val intent = Intent(this@AST_Biceps_e_Costas, Biceps_e_Costas::class.java)
            startActivity(intent)
            finish()
        }
    }
