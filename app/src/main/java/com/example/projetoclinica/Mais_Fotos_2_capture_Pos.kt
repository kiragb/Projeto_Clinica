...
class Mais_Fotos_2_capture_Pos: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mais_fotos2_capture_pos)
        ...
        PularFoto!!.setOnClickListener {
            val intent = Intent(this@Mais_Fotos_2_capture_Pos, Mais_Fotos_3_Pos::class.java)
