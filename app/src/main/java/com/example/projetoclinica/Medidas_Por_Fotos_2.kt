...
class Medidas_Por_Fotos_2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_medidas_por_fotos_2)
        ...
        imageView!!.setOnClickListener {
            val intent = Intent(this@Medidas_Por_Fotos_2, Adicionar_Medicoes_2::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAMERA_REQUEST && resultCode == RESULT_OK) {
            ...
            val intent = Intent(this@Medidas_Por_Fotos_2, Medidas_Por_Fotos_Frente_2::class.java )
