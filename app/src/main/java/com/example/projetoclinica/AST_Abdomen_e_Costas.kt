...
class AST_Abdomen_e_Costas: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ast_abdomen_e_costas)
        ...
        Continuar!!.setOnClickListener {
            val intent = Intent(this@AST_Abdomen_e_Costas, Adicionar_Medicoes::class.java)
            startActivity(intent)
            finish()
        }
        imageView = findViewById(R.id.imageView)
        imageView!!.setOnClickListener {
            val intent = Intent(this@AST_Abdomen_e_Costas, Abdomen_e_Costas::class.java)
            startActivity(intent)
            finish()
        }
    }
