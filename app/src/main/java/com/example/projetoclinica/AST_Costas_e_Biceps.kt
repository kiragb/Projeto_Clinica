...
class AST_Costas_e_Biceps: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ast_costas_e_biceps)
        ...
        Continuar!!.setOnClickListener {
            val intent = Intent(this@AST_Costas_e_Biceps, Adicionar_Medicoes::class.java)
            startActivity(intent)
            finish()
        }
        imageView = findViewById(R.id.imageView)
        imageView!!.setOnClickListener {
            val intent = Intent(this@AST_Costas_e_Biceps, Costas_e_Biceps::class.java)
            startActivity(intent)
            finish()
        }
    }
